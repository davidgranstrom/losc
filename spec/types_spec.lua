...
describe('Types', function()
  ...
  describe('unpack', function()
    ...
    it('can get supported types', function()
      local ptypes = Types.get(Types.pack)
      local utypes = Types.get(Types.unpack)
      assert.is_true(type(ptypes) == 'table')
      assert.is_true(type(utypes) == 'table')
    end)
  end)
end)
